...
- Each large transfer requires unique approval from authorized signers
- Approved transfers are single-use and cannot be reused for additional transfers
...
This will generate an approval ID that needs to be shared with other owners.

### Step 2: Confirm Transfer Approval

A second authorized owner must confirm the approval using the approval ID:

# Set environment variables (same as above plus approval ID)
TOKEN_ADDRESS=0x9BB81D0F7E0144E13F9e365B2522ceA57e6535B9
MULTISIG_ADDRESS=0x712143a94ecE215cF9cb9ae6F35a52b92B9eC61d
SENDER_ADDRESS=<address-sending-tokens>
RECIPIENT_ADDRESS=<address-receiving-tokens>
